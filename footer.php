					...
					<div class="span9">
						<div id="footer-1">
							...
							<ul class="unstyled">
								...
								<li class="sep">|</li>
								<li class="dlist"><a href="/privacy/">Privacy</a></li>
								<li class="dlist"><a href="/refunds/">Refunds</a></li>
								<li class="dlist"><a href="/terms/">Terms</a></li>
							</ul>							
						</div>
					</div>
					<div class="span3">
	...
	<!-- HelloBar -->
	<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/hellobar-solo/hellobar.js"></script>
	<script>
